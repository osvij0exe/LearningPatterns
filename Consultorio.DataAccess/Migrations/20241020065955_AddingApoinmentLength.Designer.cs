...
namespace Consultorio.DataAccess.Migrations
{
    ...
    [Migration("20241020065955_AddingApoinmentLength")]
    partial class AddingApoinmentLength
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Consultorio.Entities.ConsultorioEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3402cef6-7ff7-4839-a2ef-b0d99da538ca"),
                            Active = true,
                        ...
                        new
                        {
                            Id = new Guid("6b959f19-9057-40a8-a35b-4913c265b8f5"),
                            Active = true,
                            CreationDate = new DateTime(2024, 1, 7, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("3138c493-ecf2-4831-82a9-192914ee872a"),
                            Active = true,
                            CreationDate = new DateTime(2024, 1, 7, 0, 0, 0, 0, DateTimeKind.Unspecified),
